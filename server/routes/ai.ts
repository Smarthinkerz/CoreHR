...
// This router is mounted at the bare "/api" prefix, so gating is applied at the
// router level rather than the mount. All AI endpoints require the "ai_insights" feature (Enterprise tier).
router.use(requireFeature('ai_insights'));
